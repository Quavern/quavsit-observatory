...
| `observatory/publish.py` | Aggregates a UTC day, redacts, validates, writes `data/`, commits and pushes. |
...
Samples at 02:40, 05:40 … 23:40 UTC; the day so far is published at :55 after each sample, and the finished day at 00:25 UTC. The units load no secret: the Observatory needs no key.
